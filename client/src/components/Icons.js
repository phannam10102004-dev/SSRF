...
export const HelpIcon = ({ size = 24, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const AlertTriangleIcon = ({ size = 24, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const LikeIcon = ({ size = 24, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    <path d="M5 15h9.5a3.5 3.5 0 0 0 0-7H12"></path>
    <path d="M7 15v4a2 2 0 0 0 2 2h6.5a3.5 3.5 0 0 0 0-7"></path>
  </svg>
);

export const CommentBubbleIcon = ({ size = 24, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const UserPlusIcon = ({ size = 24, color = "currentColor" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
